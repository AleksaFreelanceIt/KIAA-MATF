...
int main(){
  ...
  int suma_1 = dajkstra(pocetak, put_1, graf);
  int suma_2 = dajkstra(pocetak, put_2, graf);
  
  if(suma_1 < suma_2){ suma_1 += dajkstra(put_1, kraj, graf); cout<<suma_1<<endl;}
  else {suma_2 = dajkstra(put_2,kraj,graf); cout << suma_2<< endl;}
